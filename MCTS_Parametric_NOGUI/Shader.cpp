 ...
 * @return					program id
 */
unsigned int Shader::createProgram(const string& vertex_file, const string& fragment_file) {
	std::string source;
...
unsigned int Shader::createProgram(const string& vertex_file, const string& geometry_file, const string& fragment_file) {
	std::string source;
	loadTextFile(vertex_file, source);
	vertex_shader = compileShader(source, GL_VERTEX_SHADER);
