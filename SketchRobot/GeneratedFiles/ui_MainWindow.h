...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        actionPenColorBody = new QAction(MainWindowClass);
        actionPenColorBody->setObjectName(QStringLiteral("actionPenColorBody"));
        ...
        actionMode3DView->setObjectName(QStringLiteral("actionMode3DView"));
        ...
        menuColor->addAction(actionPenColorBody);
    ...
    void retranslateUi(QMainWindow *MainWindowClass)
    {
        ...
        actionPenColorBody->setText(QApplication::translate("MainWindowClass", "Body", 0));
        ...
        actionModeSketch->setText(QApplication::translate("MainWindowClass", "Sketch", 0));
        actionMode3DView->setText(QApplication::translate("MainWindowClass", "3D View", 0));
