...
void ParametricLSystem::draw(const String& model, RenderManager* renderManager) {
	...
	for (int i = 0; i < model.length(); ++i) {
		...
		if (model[i].name == "Door") {			
			...
			// 左側の横壁
			{
				...
				glutils::drawQuad(door_depth, h * 0.75, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 上側の横壁
			{
				...
				glutils::drawQuad(w, door_depth, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// ドアを描画
			{
				...
				glutils::drawQuad(w, h * 0.75, glm::vec4(0.8, 0.5, 0.3, 1), mat, doorVertices);
			}
			...
			// 下の壁を描画
			{
				...
				glutils::drawQuad(w, h * 0.21, 
					glm::vec2(x * 0.05, y * 0.05), 
					glm::vec2((x + w) * 0.05, y * 0.05), 
					glm::vec2((x + w) * 0.05, (y + h * 0.21) * 0.05), 
					glm::vec2(x * 0.05, (y + h * 0.21) * 0.05), 
					mat, wallVertices);
			}
			...
			// 左側の横壁
			{
				...
				mat = glm::rotate(mat, deg2rad(90), glm::vec3(0, 1, 0));
				glutils::drawQuad(window_depth, h * 0.5, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 上側の横壁
			{
				...
				mat = glm::rotate(mat, deg2rad(90), glm::vec3(1, 0, 0));
				glutils::drawQuad(w, window_depth, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 下側の横壁
			{
				...
				mat = glm::rotate(mat, deg2rad(-90), glm::vec3(1, 0, 0));
				glutils::drawQuad(w, window_depth * 1.5, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 下側の台の前面
			{
				...
				glutils::drawQuad(w, h * 0.04, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 下側の台の左側面
			{
				...
				mat = glm::rotate(mat, deg2rad(-90), glm::vec3(0, 1, 0));
				glutils::drawQuad(window_depth * 0.5, h * 0.04, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 下側の台の下側面
			{
				...
				mat = glm::rotate(mat, deg2rad(90), glm::vec3(1, 0, 0));
				glutils::drawQuad(w, window_depth * 0.5, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 窓を描画
			{
				...
				glutils::drawQuad(w, h * 0.5, glm::vec4(1, 1, 1, 1), mat, windowVertices);
			}
			...
			// 左側の横壁
			{
				...
				mat = glm::rotate(mat, deg2rad(90), glm::vec3(0, 1, 0));
				glutils::drawQuad(window_depth, h * 0.8, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 上側の横壁
			{
				...
				mat = glm::rotate(mat, deg2rad(90), glm::vec3(1, 0, 0));
				glutils::drawQuad(w * 0.8, window_depth, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// 窓を描画
			{
				...
				glutils::drawQuad(w * 0.8, h * 0.8, glm::vec4(1, 1, 1, 1), mat, windowVertices);
			}
			...
			// バルコニーの台
			{
				...
				glutils::drawBox(w, 1.0, balcony_depth, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// バルコニーの手すり
			{
				...
				glutils::drawBox(w, 0.4, 1.0, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// バルコニーの左側壁
			{
				...
				glutils::drawBox(0.4, h * 0.4 + 1.0, balcony_depth, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
			}
			...
			// バルコニーの垂直棒
			{
				...
				for (int i = 0; i < n; ++i) {
					...
					glutils::drawCylinderY(0.2, 0.2, h * 0.4 - 0.4, glm::vec4(0.8, 0.8, 0.8, 1), mat, vertices);
				}
			}
	...
	renderManager->addObject("object2", "textures/window.jpg", windowVertices, true);
	renderManager->addObject("object3", "textures/door.jpg", doorVertices, true);
	renderManager->addObject("object4", "textures/wall.jpg", wallVertices, true);
}
